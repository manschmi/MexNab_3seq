...
#log2 counts
python /Users/schmidm/ms_tools/MS_Metagene_Tools/log2_matrix.py deeptools_out/ORFT/introns_0_1_3ssm1p2k_joined.gz
...
```{r}
(bam_files <- read.table('/Users/schmidm/Documents/Results/Lexogen_RNAseq_2/file_rename_map_Lexogen2.txt', stringsAsFactors = FALSE,
...
```{bash, eval = FALSE}
cd /Users/schmidm/Documents/Results/Lexogen_RNAseq_2/STAR_bw/norm_and_pA_filtered_bw
...
for f in *plus*.bw
  do
    ...
    /Users/schmidm/ms_tools/bigWigAverageOverBed $f ${introns/.bed/_plus.bed} tmp_plus.tab
    /Users/schmidm/ms_tools/bigWigAverageOverBed ${f//plus/minus} ${introns/.bed/_minus.bed} tmp_minus.tab
    cat tmp_plus.tab tmp_minus.tab > bigWigAverageOverBed_counts/${outfname}"_introns.tab"

    rm tmp_plus.tab
    rm tmp_minus.tab

    /Users/schmidm/ms_tools/bigWigAverageOverBed $f ${exon2s/.bed/_plus.bed} tmp_plus.tab
    /Users/schmidm/ms_tools/bigWigAverageOverBed ${f//plus/minus} ${exon2s/.bed/_minus.bed} tmp_minus.tab
    cat tmp_plus.tab tmp_minus.tab > bigWigAverageOverBed_counts/${outfname}"_exon2s.tab"

    rm tmp_plus.tab
    rm tmp_minus.tab

    /Users/schmidm/ms_tools/bigWigAverageOverBed $f ${exon2s/.bed/_endm200_plus.bed} tmp_plus.tab
    /Users/schmidm/ms_tools/bigWigAverageOverBed ${f//plus/minus} ${exon2s/.bed/_endm200_minus.bed} tmp_minus.tab
...
```{r}
path <- '/Users/schmidm/Documents/Results/Lexogen_RNAseq_2/STAR_bw/norm_and_pA_filtered_bw/bigWigAverageOverBed_counts/'
