...
/Users/schmidm/Documents/genomewide_datasets/scripts/liftOver_and_conversionTools/liftOver Pugh_measured_nucleosomes_roman0.bed V62_2009_02_18_V64_2011_02_03_plain.over.chain Pugh_measured_nucleosomes_roman0_sacCer3.bed conversion_failed.bed
...
```{r}
(nucs <- read_tsv('/Users/schmidm/Documents/genomewide_datasets/ChIP_CLiP_yeast/Pugh_nucleosomes/Pugh_measured_nucleosomes_sacCer3.bed',
...
```{r}
(anno <- read_tsv('/Users/schmidm/Documents/genomewide_datasets/annotations/sacCer3/Steinmetz_sacCer3_latin.bed', col_names = c('chr', 'start', 'end', 'anno', 'score', 'strand')) %>%
...
filter(uniquely_assigned_nucs, !is.na(strand)) %>%
  mutate(nuc = paste(nuc, name, sep=':'),
         name = 0) %>%
  write.table(., file='/Users/schmidm/Documents/genomewide_datasets/ChIP_CLiP_yeast/Pugh_nucleosomes/Pugh_measured_nucleosomes_sacCer3_unique_with_strand.bed', col.names = FALSE, row.names = FALSE, quote=FALSE, sep='\t')
```
...
bed="/Users/schmidm/Documents/genomewide_datasets/ChIP_CLiP_yeast/Pugh_nucleosomes/Pugh_measured_nucleosomes_sacCer3_unique_with_strand.bed"
...
plus1_bed="/Users/schmidm/Documents/genomewide_datasets/ChIP_CLiP_yeast/Pugh_nucleosomes/Pugh_measured_plus1_nucleosomes_sacCer3_unique_with_strand.bed"
...
#log2
python /Users/schmidm/ms_tools/MS_Metagene_Tools/log2_matrix.py deeptools_out/nucleosomes/Mex_0_1_plus1nuc_startpm1000_joined.gz
...
#log2
python /Users/schmidm/ms_tools/MS_Metagene_Tools/log2_matrix.py ../deeptools_out/nucleosomes/masked_Mex_0_1_plus1nuc_startpm1000_joined.gz
...
```{r}
(nuc1 <- RMetaTools::load_deeptoolsmatrix('/Users/schmidm/Documents/Results/Lexogen_RNAseq_2/STAR_bw/norm_and_pA_filtered_bw/deeptools_out/nucleosomes/Mex_0_1_plus1nuc_startpm1000_joined.gz'))
...
```{r}
(nuc1_masked <- RMetaTools::load_deeptoolsmatrix('/Users/schmidm/Documents/Results/Lexogen_RNAseq_2/STAR_bw/norm_and_pA_filtered_bw/deeptools_out/nucleosomes/masked_Mex_0_1_plus1nuc_startpm1000_joined.gz'))
...
```{r}
(div_orfs <- read_tsv('/Users/schmidm/Documents/genomewide_datasets/annotations/sacCer3/Steinmetz_sacCer3_latin_divergent_ORFTs_pairs_leq500bp.bed', col_names = c('chr', 'start', 'end', 'anno', 'score', 'strand')) %>%
   separate(anno, c('id', 'type', 'name', 'common_name'), sep=':'))
```
...
```{r}
(tandem_orfs <- read_tsv('/Users/schmidm/Documents/genomewide_datasets/annotations/sacCer3/Steinmetz_sacCer3_latin_tandem_ORFTs_pairs_leq500bp.bed', col_names = c('chr', 'start', 'end', 'anno', 'score', 'strand')) %>%
   separate(anno, c('id', 'type', 'name', 'common_name'), sep=':'))
```
...
```{r}
(crac <- RMetaTools::load_deeptoolsmatrix('/Users/schmidm/Documents/genomewide_datasets/ChIP_CLiP_yeast/Tollervey_RNAP_CRAC/deeptools_out/CRAC_plus1nuc_startpm1000_joined.gz') %>%
...
```{r}
(netseq <- RMetaTools::load_deeptoolsmatrix('/Users/schmidm/Documents/genomewide_datasets/ChIP_CLiP_yeast/Churchman_NETseq/deeptools_out/NETseq_plus1nuc_startpm1000_joined.gz') %>%
   mutate(log2_value = log2(value)))
```
...
```{r}
(chipseq <- RMetaTools::load_deeptoolsmatrix('/Users/schmidm/Documents/genomewide_datasets/ChIP_CLiP_yeast/Henikoff_Rpb3FLAG_ChIPseq/deeptools_out/ChIPseq_plus1nuc_startpm1000.gz') %>%
   mutate(log2_value = log2(value)))
```
...
/Users/schmidm/ms_tools/bedGraphToBigWig Pugh_measured_nucleosomes_binary_sacCer3.bedgraph /Users/schmidm/Documents/genomewide_datasets/annotations/sacCer3/sacCer3_chrom.sizes Pugh_measured_nucleosomes_sacCer3.bw
...
```{r}
(nuc_relplus1 <- RMetaTools::load_deeptoolsmatrix('/Users/schmidm/Documents/genomewide_datasets/ChIP_CLiP_yeast/Pugh_nucleosomes/Pugh_measured_nucleosomes_rel_plus1nuc.gz'))
```
...
/Users/schmidm/ms_tools/bedGraphToBigWig ${ORFs/.bed/_TSS_plus.bedgraph} /Users/schmidm/Documents/genomewide_datasets/annotations/sacCer3/sacCer3_chrom.sizes ${ORFs/.bed/_TSS_plus.bw}

/Users/schmidm/ms_tools/bedGraphToBigWig ${ORFs/.bed/_TSS_minus.bedgraph} /Users/schmidm/Documents/genomewide_datasets/annotations/sacCer3/sacCer3_chrom.sizes ${ORFs/.bed/_TSS_minus.bw}
...
```{r}
(tsss_relplus1 <- RMetaTools::load_deeptoolsmatrix('/Users/schmidm/Documents/genomewide_datasets/ChIP_CLiP_yeast/Pugh_nucleosomes/ORF_TSSs_rel_plus1nuc_joined.gz'))
```
